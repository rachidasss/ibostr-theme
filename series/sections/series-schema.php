...
$schema = [
    ...
    'description' => has_excerpt()
        ? get_the_excerpt()
        : 'Watch ' . get_the_title() . ' with iBostreaming. All seasons and episodes available.',
    'url' => get_permalink(),
    'provider' => [
        '@type' => 'Organization',
        'name' => 'iBostreaming',
...
$schema['offers'] = [
    ...
    'description' => 'iBostreaming subscription including ' . get_the_title() . ' and 200,000+ movies & shows',
    'seller' => [
        '@type' => 'Organization',
        'name' => 'iBostreaming',
    ],
