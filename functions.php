...
define('IPTV_MAIN_SITE_URL', 'https://ibostreaming.com');
 ...
 * NOTE: Commented out — all checkout flows now redirect to https://panel.ibostreaming.com/
 */
/*
...
// NOTE: Commented out — checkout redirects now go to https://panel.ibostreaming.com/
/*
...
if (class_exists('WooCommerce')) {
    ...
    // NOTE: Commented out — redirects now go to https://panel.ibostreaming.com/
            ...
            (function () {
                ...
                if (form) {
                    form.addEventListener('submit', function (e) {
                        e.preventDefault();
                        window.location.href = 'https://panel.ibostreaming.com/';
                    });
                }
            })();
        </script>
