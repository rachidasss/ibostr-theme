    ...
    function iptv_plan_faq_defaults($months)
    {
        ...
        return array_merge($items, array(
            ...
            array(
                ...
                'a' => 'You are covered by our 7-day money-back guarantee, so you can test the full service and get your money back if it does not work for you.',
            ),
        ));
    }
}
...
add_action('init', function () {
    ...
    // ── Schema ───────────────────────────────────────────────────────────────
    $register('plan_schema_description', '%s iBostreaming IPTV subscription: 40,000+ live channels, 200,000+ movies and series in 4K and HD, on 1 to 4 screens. No contract and no auto-renew.', true);
});
