...
add_action('init', function () {
    ...
    pll_register_string('offer_faq_a1', 'iBostreaming works on Smart TVs, Android, iPhone & iPad, Amazon Firestick, MAG boxes, Windows and macOS — basically any device with an internet connection.', $group);
