...
if (!function_exists('iptv_front_page_analysis_elements')) {
    ...
    function iptv_front_page_analysis_elements($post_id)
    {
        ...
        // Hero (H1).
        $out[] = array('structure', '<h1>' . $f('hero_title', 'iBostreaming Without Limits. Every Match. Every Channel.')
            . ' ' . $f('hero_title_span', 'One Subscription.')
            . ' ' . $f('hero_title_3', '$1,000 Saved. Zero Compromises.') . '</h1>');
        $out[] = array('copy', '<p>' . $f('hero_subtitle', 'Looking for iBostreaming? iBostreaming offers 40,000+ live channels, 200,000+ movies & series, and every sport in 4K/8K — on any device, instantly.') . '</p>');
        ...
        $out[] = array('structure', '<img src="https://ibostreaming.com/wp-content/uploads/2026/07/movies-series.webp" alt="'
            . esc_attr($f('vod_image_alt', 'A selection of movies and series available on iBostreaming')) . '" />');
        ...
        $out[] = array('structure', '<img src="https://ibostreaming.com/wp-content/uploads/2026/08/live-sports.webp" alt="'
            . esc_attr($f('sports_image_alt', 'Live sport available on iBostreaming')) . '" />');
    ...
    function iptv_front_page_support_cards($post_id)
    {
        ...
        return array(
            array(
                ...
                'value' => iptv_front_page_field($post_id, 'contact_card_email_value', 'support@ibostreaming.com'),
            ...
            array(
                ...
                'value' => iptv_front_page_field($post_id, 'contact_card_telegram_value', '@iBostreaming'),
