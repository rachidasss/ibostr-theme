...
<section class="devices dv2-section">
    <div class="devices-inner">
        <div class="dv2-section-head">
            <h2><?php echo esc_html(iptv_text('devices_section_title', 'Works on Any Device, Anywhere.')); ?></h2>
            <p><?php echo esc_html(iptv_text('devices_subtitle', 'Stream iBostreaming on any device you already own. No new hardware needed.')); ?></p>
        </div>
