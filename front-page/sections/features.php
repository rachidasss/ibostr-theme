...
<section class="features dv2-section" id="features">
    <div class="features-inner">
        <div class="dv2-section-head">
            <h2><?php echo esc_html(iptv_text('features_title', 'One Subscription. Every Channel Worldwide.')); ?></h2>
            <p>
        ...
        <div class="dv2-features-cta">
            ...
            <p class="dv2-features-cta-note">
                <?php echo esc_html(iptv_text('features_cta_note', '7-day money-back guarantee · Instant activation · No auto-renew')); ?>
            </p>
        </div>
    </div>
</section>
