<section class="cta">
    ...
    <div class="cta-content">
        <h2>
            <?php echo esc_html(iptv_text('cta_title', 'Guaranteed 0% Buffering During Big Matches')); ?>
        </h2>
        <p>
            <?php echo esc_html(iptv_text('cta_subtitle', 'Built on a dedicated global CDN so the picture holds when everyone is watching the same match.')); ?>
        </p>
        <?php
        ...
        <div class="cta-features">
            <div class="cta-feature">
                ...
                <?php echo esc_html(iptv_text('cta_f1', '180+ Global Data Centers')); ?>
            </div>
            <div class="cta-feature">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polyline points="20 6 9 17 4 12" />
                </svg>
                <?php echo esc_html(iptv_text('cta_f2', '99.9% Guaranteed Uptime')); ?>
            </div>
            <div class="cta-feature">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
                </svg>
                <?php echo esc_html(iptv_text('cta_f3', '24/7 Live Support Active')); ?>
            </div>
        </div>
    </div>
    </div>
