...
$schema = [
    ...
    'name' => get_the_title() . ' on iBostreaming',
    'description' => has_excerpt()
        ? get_the_excerpt()
        : 'Watch ' . get_the_title() . ' live stream with iBostreaming. No cable required.',
    'url' => get_permalink(),
...
$schema['offers'] = [
    ...
    'description' => 'iBostreaming subscription including ' . get_the_title() . ' and 40,000+ channels',
    'seller' => [
        '@type' => 'Organization',
        'name' => 'iBostreaming',
    ],
