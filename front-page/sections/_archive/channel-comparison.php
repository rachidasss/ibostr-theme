...
$comp_subtitle = tpl_str('See how iBostreaming compares to cable for watching %s');
$competitor_name = tpl_str('Cable TV');
$our_name = tpl_str('iBostreaming');
...
$comp_ours_total_lbl = tpl_str('iBostreaming Annual Cost');
