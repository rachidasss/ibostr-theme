...
<header class="site-header offer-header" id="site-header">
    <div class="container nav-container">
        ...
        <a href="<?php echo home_url('/'); ?>" class="logo">
            ...
            $iptv_offer_logo     = iptv_text('lp_nav_logo', 'https://ibostreaming.com/logo.png');
            $iptv_offer_logo_alt = iptv_text('lp_nav_logo_alt', 'iBostreaming IPTV');
            ?>
            <img src="<?php echo esc_url($iptv_offer_logo); ?>"
                sizes="115px" width="240" height="123" alt="<?php echo esc_attr($iptv_offer_logo_alt); ?>"
