...
<section class="dv2-journey" id="how-it-works">
    <div class="dv2-journey-copy">
        <h2 class="dv2-journey-title">
            <?php echo esc_html(iptv_text('steps_title', 'Start Streaming in 3 Simple Steps')); ?>
        </h2>
        <div class="dv2-journey-note">
            <span class="dv2-journey-note-mark" aria-hidden="true">$</span>
            <?php echo esc_html(iptv_text('steps_subtitle', 'Subscribing and watching is easy and smooth — in minutes you\'re ready to watch.')); ?>
        </div>
