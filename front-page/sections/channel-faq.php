...
$faq_subtitle = tpl_str('Common questions about watching %s with iBostreaming');
...
if (empty($faq_items)) {
    $faq_items = [
        ['faq_q' => tpl_str('How do I watch %s with iBostreaming?'), 'faq_a' => tpl_str('Simply subscribe to any iBostreaming plan, download our app on your device, and search for %s. You\'ll be streaming in minutes.')],
        ...
        ['faq_q' => tpl_str('Is there a free trial?'), 'faq_a' => tpl_str('We do not offer a free trial. Instead every plan carries a 7-day money-back guarantee, so you can test the full service and get your money back if it does not work for you.')],
        ['faq_q' => tpl_str('Do I need a cable subscription?'), 'faq_a' => tpl_str('No! iBostreaming is a standalone streaming service. No cable, no satellite dish, no contracts. Just an internet connection.')],
    ];
}
