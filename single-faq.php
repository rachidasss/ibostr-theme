 ...
 *   4. CTA section — "Watch iBostreaming from anywhere"
 */
...
<?php while (have_posts()) : the_post(); ?>
    ...
    $cta_url = ($lang === 'en')
        ? 'https://ibostreaming.com/#pricing'
        : 'https://ibostreaming.com/' . $lang . '/#pricing';
    ?>
    <section class="cta">
        <div class="cta-box">
            <div class="cta-content">
                <h2><?php echo esc_html(iptv_text('faq_cta_title', 'Watch iBostreaming from anywhere')); ?></h2>
